...
def sale_products(request):
    ...
    return render(request, 'store/sections/sale.html', {'products': products})
...
def featured_products(request):
    ...
    return render(request, 'store/sections/featured.html', {'products': products})
